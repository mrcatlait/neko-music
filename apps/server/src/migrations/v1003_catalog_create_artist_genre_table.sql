CREATE TABLE "catalog"."ArtistGenre" (
  ...
  CONSTRAINT "FK_ArtistGenre_Artist" FOREIGN KEY ("artistId") REFERENCES "catalog"."Artist" ("id") ON DELETE CASCADE,
  CONSTRAINT "FK_ArtistGenre_Genre" FOREIGN KEY ("genreId") REFERENCES "catalog"."Genre" ("id") ON DELETE CASCADE,
