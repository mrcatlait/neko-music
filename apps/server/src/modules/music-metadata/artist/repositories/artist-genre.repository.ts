...
export class ArtistGenreRepository {
  ...
  create(artistGenre: Omit<ArtistGenreEntity, 'created_at'>): Promise<ArtistGenreEntity> {
  ...
  createMany(artistGenres: Omit<ArtistGenreEntity, 'created_at'>[]): Promise<ArtistGenreEntity[]> {
